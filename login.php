...
<body>
    <div class="container rounded shadow-lg px-4 py-5 mt-5 bg-white" style="max-width: 450px">
    <h1 class="text-center">ABSENSI.KU</h1><p class="text-center mb-4">CV. ASGARDIAN</p>
