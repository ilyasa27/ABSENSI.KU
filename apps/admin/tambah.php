<?php
    ...
    if (isset($_POST['tambah_admin'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql="INSERT INTO tbl_admin (kode_admin,nama,nim,email) VALUES ('$kode_admin','$nama','$nim','$email')";
            //Menyimpan ke tabel admin
...
<form action="apps/admin/tambah.php" method="post" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label>Nomor Induk Mahasiwa (NIM) :</label>
                <input type="text" name="nim" class="form-control"  value="" placeholder="Masukan Nomor Induk Mahasiwa" required>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
